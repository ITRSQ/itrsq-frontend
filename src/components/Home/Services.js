      ...
      <div className="card-container-services">
        <div>
          ...
          <p className="txt-description-large-black" data-aos="fade-up">
            ...
            throughout the design process. Your final product will be a <span>
            beautiful</span>, <span>modern</span> and{" "} <span>responsive</span> website that you’ll be proud to share with
            the world.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="txt-description-large-black" data-aos="fade-up" data-aos-delay={600}>
            ...
            something, want your website redesigned or updated, you can count
            on our assistance.
          </p>
        </div>
      </div>
